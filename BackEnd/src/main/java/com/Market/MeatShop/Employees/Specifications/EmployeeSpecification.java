...
public class EmployeeSpecification {
  ...
  public static Specification<Employee> betweenCreatingDates(
      LocalDateTime fromCreatedAt, LocalDateTime toDate) {
  ...
  public static Specification<Employee> betweenUpdatingDates(
      LocalDateTime fromUpdatedAt, LocalDateTime toDate) {
