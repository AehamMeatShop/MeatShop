...
public class EmployeeComparison {
  ...
  /**
   * Compares employee fields that are present in the update request Ignores timestamps (createdAt,
   * updatedAt) and other auto-generated fields
   *
  ...
  public static boolean hasNoChanges(
      Employee original, Employee updated, UpdateEmployeeReq updateRequest) {
